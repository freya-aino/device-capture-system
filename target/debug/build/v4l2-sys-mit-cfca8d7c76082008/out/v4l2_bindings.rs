...
pub const V4L2_CID_USER_UVC_BASE: u32 = 9968352;
pub const V4L2_CID_USER_RKISP1_BASE: u32 = 9968416;
pub const V4L2_CID_USER_MALI_C55_BASE: u32 = 9968432;
...
pub const V4L2_FMTDESC_FLAG_ENUM_ALL: u32 = 2147483648;
...
pub const V4L2_CTRL_WHICH_MIN_VAL: u32 = 251789312;
pub const V4L2_CTRL_WHICH_MAX_VAL: u32 = 251854848;
...
pub const V4L2_CTRL_FLAG_HAS_WHICH_MIN_MAX: u32 = 4096;
...
pub const V4L2_MPEG_VBI_IVTV_MAGIC0: &[u8; 5usize] = b"itv0\0";
pub const V4L2_MPEG_VBI_IVTV_MAGIC1: &[u8; 5usize] = b"ITV0\0";
...
fn bindgen_test_layout_v4l2_ext_control__bindgen_ty_1() {
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).p_rect) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(v4l2_ext_control__bindgen_ty_1),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).p_hdr10_cll_info) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(v4l2_ext_control__bindgen_ty_1),
            "::",
            stringify!(p_hdr10_cll_info)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).p_hdr10_mastering_display) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(v4l2_ext_control__bindgen_ty_1),
            "::",
            stringify!(p_hdr10_mastering_display)
        )
    );
    assert_eq!(
...
pub const v4l2_ctrl_type_V4L2_CTRL_TYPE_RECT: v4l2_ctrl_type = 263;
...
fn bindgen_test_layout_v4l2_create_buffers() {
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).max_num_buffers) as usize - ptr as usize },
        232usize,
        concat!(
            "Offset of field: ",
            stringify!(v4l2_create_buffers),
            "::",
            stringify!(max_num_buffers)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).reserved) as usize - ptr as usize },
...
#[test]
fn bindgen_test_layout_v4l2_remove_buffers() {
    const UNINIT: ::std::mem::MaybeUninit<v4l2_remove_buffers> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<v4l2_remove_buffers>(),
        64usize,
        concat!("Size of: ", stringify!(v4l2_remove_buffers))
    );
    assert_eq!(
        ::std::mem::align_of::<v4l2_remove_buffers>(),
        4usize,
        concat!("Alignment of ", stringify!(v4l2_remove_buffers))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).index) as usize - ptr as usize },
        0usize,
